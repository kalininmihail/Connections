...
public class ContactProgram {
    public static void Connection(String login, String password) {
        ...
        try (BufferedReader reader = Files.newBufferedReader(Paths.get("/Users/mihailkalinin/Downloads/BDVClasse-main/ZadanieVClasse-main/out/production/ZadanieVClasse-main/ggg.txt"))) {
            String line;
